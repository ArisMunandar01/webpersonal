<div class="col-lg-9 mt-2 rounded-3"> 
    <div class="card">
  <div class="card-header">
    Home
  </div>
  <div class="card-body">
    <h5 class="card-title"> DeRestoHill - APLIKASI PEMESANAN MAKANAN DAN MINUMAN RestoHill </h5>
    ...
    <a href="#" class="btn btn-primary"> Order New </a>
  </div>
</div>
    </div>